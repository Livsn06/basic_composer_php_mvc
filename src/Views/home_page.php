...
$title = htmlspecialchars($title ?? 'Pangasinan State University');
...
<section style="display: flex; flex-wrap: wrap; background-color: #003366; color: white;">
    <div style="flex: 1; min-width: 300px; padding: 60px 50px; background: linear-gradient(45deg, #002244, #003366); border-right: 1px solid rgba(255,255,255,0.1);">
        ...
        <h3 style="font-size: 32px; margin: 0 0 20px 0;">{$data['visionData']['title']}</h3>
    ...
    <div style="flex: 1; min-width: 300px; padding: 60px 50px; background-color: #002b55;">
        ...
        <h3 style="font-size: 32px; margin: 0 0 20px 0;">{$data['missionData']['title']}</h3>
        <p style="font-size: 18px; line-height: 1.8; color: #fff; max-width: 500px;">
            {$data['missionData']['description']}
        </p>
    </div>
</section>
HTML;
...
foreach ($data['coreValuesData']['items'] as $value) {
...
<section style="background-color: #003366; padding: 80px 50px; color: white;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <div style="text-align: center; margin-bottom: 50px;">
            <h2 style="font-size: 36px; color: #ffcc00; margin-bottom: 10px;">{$data['coreValuesData']['title']}</h2>
...
foreach ($data['goalData']['items'] as $index => $item) {
    ...
    <div style="display: flex; align-items: flex-start; gap: 20px; padding: 25px; background: #fdfdfd; border: 1px solid #eee;">
        <span style="font-size: 40px; font-weight: bold; color: rgba(0, 51, 102, 0.1); line-height: 1;">$num</span>
...
<section style="max-width: 1200px; margin: 80px auto; padding: 0 50px;">
    <div style="text-align: center; margin-bottom: 50px;">
        <h2 style="font-size: 36px; color: #003366; margin-bottom: 10px;">{$data['goalData']['title']}</h2>
...
foreach ($data['policyData']['items'] as $item) {
    ...
    <div style="margin-bottom: 25px; display: flex; gap: 20px;">
        ...
        <p style="margin: 0; font-size: 17px; color: #555; line-height: 1.7;">$item</p>
    </div>
HTML;
}
...
<section style="background-color: #f4f4f4; border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 80px 50px;">
    <div style="max-width: 900px; margin: 0 auto; position: relative;">
        ...
        <h2 style="color: #003366; font-size: 28px; margin-bottom: 30px; text-align: center;">{$data['policyData']['title']}</h2>
...
<html lang="en">
            ...
            <nav> 
                <ul style="list-style: none; display: flex; margin: 0; padding: 0;"> 
                    <li style="margin-left: 25px;">
                        <a href="/" style="text-decoration: none; color: #003366; font-weight: 700;">Home</a>
                    </li> 
                    <li style="margin-left: 25px;">
                        <a href="/about" style="text-decoration: none; color: #6d6d6d; font-weight: 600;">About</a>
    ...
    <footer style="background-color: #222; color: #bbb; padding: 40px 50px; text-align: center; border-top: 10px solid #003366;"> 
        ...
        <div style="margin-top: 10px;"> 
            <a href="#" style="color: #ffcc00; text-decoration: none;">Privacy Policy</a> | <a href="#" style="color: #ffcc00; text-decoration: none; margin-left: 10px;">Contact Us</a> 
        </div> 
    </footer>
